...
"""
        self._write_file(os.path.join(project_path, "settings.gradle"), settings_content)
...
"""
        self._write_file(os.path.join(project_path, "build.gradle"), project_build_content)
...
"""
        self._write_file(os.path.join(project_path, "gradle.properties"), gradle_props)
